...
if (isset($_SESSION['establishment_id'])) {
    ...
    if (isset($_POST['change_password'])) {
        ...
        $query = mysqli_query($conn, "SELECT password FROM `establishments` WHERE id = '$establishment_id'");
        ...
        if (password_verify($current_password, $db_password)) {
            if ($new_password === $confirm_password) {
                ...
                $update_query = mysqli_query($conn, "UPDATE `establishments` SET password = '$hashed_password' WHERE id = '$establishment_id'");
...
<body>
    ...
    <Div class="container blurb" style="margin-top: 2%;">
        ...
        <form action="" method="post">
            ...
            <input type="new_password" class="form-control" id="new_password" name="new_password" oninput="checkPassword()" required>
        ...
        <div style="position: relative;">
            <input type="password" class="form-control" id="confirm_password" name="confirm_password" oninput="checkPassword()" required>
            <span id="showConfirmPassword" class="eye-icon" onclick="toggleConfirmPasswordVisibility()" style="font-size: 20px; position: absolute; right: 10px; top: 50%; transform: translateY(-45%); cursor: pointer; color: black;">
                <i class="fa fa-eye"></i>
            </span>
        </div>
        ...
        <a href="account_establishment.php" class="btn btn-danger">Back to Account</a>
    </div>
</body>
<!-- password security -->
<script>

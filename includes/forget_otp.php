...
<html lang="en">
  <head>
    <title>Tinig Kalinga Email Verification</title>
  ...
  <body>
    ...
    <div class="container">  
      ...
      <p style="text-align: center; color:whitesmoke;">Change password requires OTP for validity on Email</p>
      ...
      <?php endif; ?>
        <form action="send_forget_otp.php" method="post">

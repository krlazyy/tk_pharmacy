                    ...
                    <div class="navbar-content d-flex justify-content-between align-items-center">
                        ...
                        <div class = "navbar-box">
                            ...
                            <ul class = "navbar-nav d-flex align-items-center">
                                ...
                                <li class = "nav-item">
                                    <a href = "admin_consumer.php" class = "nav-link nav-active text-white text-nowrap">Consumers</a>
                                </li>
                                <li class = "nav-item">
                 ...
                 <table class="table" id="myTable">
                  ...
                  <tbody>
                      ...
                      while($row = $query->fetch_assoc()){
                          ...
                          <td>
                          <a class='btn-sm btn-success' href='admin_consumer_edit.php?edit=".$row['user_id']."'>Edit</a>
                          <a class='btn-sm btn-danger' href='admin_consumer_delete.php?delete=".$row['user_id']."'>Delete</a>
                          </td>
                          </tr>
                          ";
                      }

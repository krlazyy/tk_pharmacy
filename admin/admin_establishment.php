...
<head>
	...
	<title>Admin Establishment</title>
    <style type="text/css">
       input[type=text] {
            color: black;
        }
                        ...
                        <div class="navbar-content d-flex justify-content-between align-items-center">
                            ...
                            <div class = "navbar-box">
                                ...
                                <ul class = "navbar-nav d-flex align-items-center">
                                    ...
                                    <li class = "nav-item">
                                        <a href = "admin_establishment.php" class = "nav-link text-white nav-active text-nowrap">Establishments</a>
                                    </li>
                                    <li class = "nav-item">
...
<div class="container-fluid blurb" style="margin-top:2%">
			<h1><b>Establishments</b></h1>
            <a href="registry_establishment.php" class="btn-lg btn-info" style="float:right;">Register Establishment</a>
			<input type="text" class="form-control" id="search" name="search" placeholder="Search Medicine" style="float: left; margin-top: 1%; margin-bottom: 1%;">
                    ...
                    while($row = $query->fetch_assoc()){
                      echo "
                        <tr>
                          ...
                          <td>".$row['location']."</td>
                          <td>".$row['category']."</td>
                          <td>".$row['establishment_contact']."</td>
                          <td>".$row['website_link']."</td>
                          <td>".$row['bio']."</td>
                          <td>
                            <a class='btn-sm btn-success' href='admin_establishment_edit.php?edit=".$row['establishment_id']."'>Edit</a>
                            <a class='btn-sm btn-danger' href='admin_establishment_delete.php?delete=".$row['establishment_id']."'>Delete</a>
                          </td>
                        </tr>
                      ";
                    }

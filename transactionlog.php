...
if (isset($_SESSION['user_id']) && isset($_SESSION['email'])) {
   ...
   <head>
      ...
      <title>Tinig Kalinga Transaction Logs</title>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"></script>
      ...
      <div class="container blurb" style="margin-top: 1%;"><center>
         <img src="includes/images/logo.png" style="margin-top: 1%;"></center>
         <h1 style="font-size: 6vh;"><b>Transaction Log</b></h1>
          <div class="container-fluid">
             <!-- Content -->
             <input type="text" class="form-control" id="search" name="search" placeholder="Search" style="float: left; margin-bottom: 1%;">
                  <button id="voiceSearchBtn" class="btn-sm btn-info form-control" style="float: left; margin-left: 5px; margin-bottom: 1%;">
    🎤 Press to Speak
</button>
             <table class="table" id="myTable">
              <thead>
               <th class="hidden"></th>
               <th class="hidden">Reciept ID</th>
            ...
            <tbody>
               <?php
               $sql = "SELECT * FROM reciept where user_id='$user_id' ORDER BY transaction_date DESC";
